 ...
 * @generated */
public class Actor_Type extends Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("dsc.spotlight.entity.Actor");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "dsc.spotlight.entity.Actor");
